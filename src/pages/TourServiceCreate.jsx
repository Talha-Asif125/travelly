  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const serviceData = {
        ...
        maxGroupSize: parseInt(availableSeats),
      ...
      if (result.success) {
        ...
        await Swal.fire({
          icon: 'success',
          title: 'Success!',
          text: `${category} service created successfully! ID: ${result.data?._id}`,
...
export default TourServiceCreate; 

...
/>
            ...
            <div className="mb-3">
  <div className="relative mb-4 flex w-[380px] flex-wrap items-stretch">
    <input
      type="search"
...
<div className="relative overflow-x-auto shadow-md sm:rounded-lg">
    <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400" >
        ...
        <tbody>
                           ...
                           <tr  key={Salary._id}  className="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                ...
                <td className="px-6 py-4">
                    ...
                    <button  className="font-medium text-blue-600 dark:text-blue-500 hover:underline " onClick={() => salaryDelete(Salary._id)}>Delete </button>
